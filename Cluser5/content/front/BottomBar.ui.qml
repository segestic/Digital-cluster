...
Item {
    ...
    Item {
        ...
        x: 1446
        y: 12
        width: Constants.width * 0.234 //450
        height: Constants.height * 0.1 //72
        ...
        Item {
            ...
            x: 382
            y: 4
            width: Constants.width * 0.0333 //64
            height: Constants.width * 0.0333 //64
            Image {
                id: cover1
                x: -10
                y: -2
        ...
        SvgPathItem {
            ...
            x: 415
            y: 0
            width: Constants.width * 0.0182 //35
            height: Constants.height * 0.094 //68
            strokeWidth: 2
            strokeColor: "#ffffff"
        ...
        Item {
            ...
            x: 0
            y: 13
            width: Constants.width * 0.185 //355
            height: Constants.height * 0.064 //46
            Text {
                id: songName
                x: 0
                y: 0
                width: Constants.width * 0.185 //355
                height: Constants.height * 0.04 //29
                color: "white"
            ...
            Text {
                ...
                x: 0
                y: 29
                width: Constants.width * 0.1849 //355
                height: Constants.height * 0.0236 //17
                color: "#d3d3d3"
                text: "QUICK TORCH"
                font.pixelSize: 14
                horizontalAlignment: Text.AlignRight
    ...
    Row {
        id: row
        y: 0
        width: Constants.width * 0.298 //572
        height: Constants.height * 0.064 //46
        anchors.verticalCenter: parent.verticalCenter
